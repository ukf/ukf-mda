...
public class UKEntityOrderingStrategyTest extends BaseDomTest {
    ...
    public void testOrder() throws XMLParserException {
        ...
        Assert.assertEquals(items.get(0), i0);
        Assert.assertEquals(items.get(1), i1);
        Assert.assertEquals(items.get(2), i2);
        Assert.assertEquals(items.get(3), i3);
        Assert.assertEquals(items.get(4), i4);
        Assert.assertEquals(items.get(5), i5);
    }
