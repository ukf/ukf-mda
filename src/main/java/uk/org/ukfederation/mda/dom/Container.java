...
public class Container {
    ...
    public interface ChildAddingStrategy {
         ...
         */
        Container addChild(@Nonnull final Container parent, @Nonnull final Element child);
    }
    ...
    @Nonnull public static final ChildAddingStrategy FIRST_CHILD = new ChildAddingStrategy() {
        ...
        @Override
        public Container addChild(@Nonnull final Container parent, @Nonnull final Element child) {
     ...
     */
    private Container(final Element child, final Container parent) {
     ...
     */
    public Container(final Element root) {
